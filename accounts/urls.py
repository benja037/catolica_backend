...
urlpatterns = [ 
    ...
    path('apoderados/subjects/<int:subject_pk>/students-auto-add/<int:profile_id>/', views_subjects.Apoderados_Subject_Post_add.as_view({'post': 'post_student_auto'}), name='subject-add-alumno-auto'),
