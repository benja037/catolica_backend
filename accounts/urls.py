...
urlpatterns = [ 
    ...
    path('apoderados/subjects/<int:subject_pk>/students-auto-remove/', views_subjects.Apoderados_Subject_Post_remove.as_view({'post': 'delete_student_auto'}), name='subject-remove-alumno-auto'),
    #Groups    
