...
urlpatterns = [ 
    ...
    path('apoderados/subjects/<int:subject_pk>/students-auto-remove/<int:profile_id>/', views_subjects.Apoderados_Subject_delete.as_view({'delete': 'delete_student_auto'}), name='subject-remove-alumno-auto'),
    #Groups    
